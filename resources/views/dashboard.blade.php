...
@guest
<a href="{{ route('products') }}" class="inline-block relative overflow-hidden bg-gradient-to-r from-primary-container to-secondary-container text-white font-label-caps text-label-caps px-8 py-4 rounded-full transition-all duration-300 hover:scale-[1.02] active:scale-95 group shadow-[0_8px_32px_rgba(255,79,163,0.3)]">
