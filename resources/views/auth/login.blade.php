    ...
    <section class="w-full lg:w-1/2 flex items-center justify-center p-gutter relative bg-[#0B0B0F]">
        ...
        <div class="w-full max-w-md bg-[#14141B] rounded-xl border border-white/10 p-container-padding shadow-[0_30px_60px_rgba(255,79,163,0.05)] backdrop-blur-xl relative z-10 flex flex-col gap-lg">
            <div class="text-center flex flex-col gap-xs">
                <h2 class="font-h2 text-h2 text-white">Welcome Back</h2>
                <p class="font-body-md text-body-md text-on-surface-variant">Sign in to access your Pocket.</p>
            </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-md">
                    ...
                    <div class="block mt-2">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox" class="rounded border-white/20 bg-surface-container-low text-primary-container shadow-sm focus:ring-primary-container focus:ring-offset-0 transition-colors" name="remember">
                            <span class="ms-2 font-body-md text-sm text-on-surface-variant">{{ __('Remember me') }}</span>
                        </label>
                    </div>
            ...
            <div class="text-center mt-sm">
                <p class="font-body-md text-body-md text-on-surface-variant text-sm">
                    Don't have an account? <a class="text-primary-container hover:text-white transition-colors underline underline-offset-4 decoration-primary-container/30" href="{{ route('register') }}">Join the Club</a>
                </p>
            </div>
        </div>
    </section>
